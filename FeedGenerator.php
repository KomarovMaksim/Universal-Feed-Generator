...
define('ATOM', 'ATOM', true);    // ATOM 1.0
class feed
{
  ...
  public $shorten  = false;             // Shorten Structure
  /**
	* Constructor
	*
	...
	*/
	function __construct($version = RSS2)
	{
	  ...
	  $this->channels['link'] = 'http://www.4sol.ru/rss';
  ...
  */
  ...
  /**
	* Set the 'language' channel element
	*
	* @access   public
	* @param    srting  value of 'language' channel tag
	* @return   void
	*/
	public function setLanguage($lang)
	{
		$this->setChannelElement['language'] = $lang;
	}
	/**
	* Set the 'generator' channel element
	*
	* @access   public
	* @param    srting  value of 'generator' channel tag
	* @return   void
	*/
	...
	*/
	...
	/**
	* Set the 'docs' channel element
	*
	* @access   public
	* @param    srting  value of 'docs' channel tag
	* @return   void
	*/
	public function setDocs($docs)
	{
		$this->setChannelElement['docs'] = $docs;
	}
	/**
	* Set the 'lastBuildDate' channel element
	*
	* @access   public
	* @param    srting  value of 'lastBuildDate' channel tag
	* @return   void
	*/
	...
	*/
	private function printHead()
	{
		...
		if($this->version == RSS2 && !$this->shorten) $out .= '<rss version="2.0"
xmlns:content="http://purl.org/rss/1.0/modules/content/"
xmlns:wfw="http://wellformedweb.org/CommentAPI/"
>'.PHP_EOL;
		elseif($this->version == RSS1 && !$this->shorten) $out .= '<rdf:RDF
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
xmlns="http://purl.org/rss/1.0/"
xmlns:dc="http://purl.org/dc/elements/1.1/"
>'.PHP_EOL;
		elseif($this->version == RSS2 && $this->shorten) $out .= '<rss version="2.0">'.PHP_EOL;;
    elseif($this->version == RSS1 && $this->shorten) $out .= '<rdf:RDF>'.PHP_EOL;;
    elseif($this->version == ATOM && $this->shorten) $out .= '<feed>'.PHP_EOL;;
		echo $out;
	}
	/**
	...
	*/
	...
	{
		if($this->version == RSS2) echo '</channel>'.PHP_EOL.'</rss>';
		elseif($this->version == RSS1) echo '</rdf:RDF>';
		else if($this->version == ATOM) echo '</feed>';
	}
	/**
	...
	*/
	private function makeNode($tagName, $tagContent, $attributes = null)
	{
		...
		if(is_array($tagContent) && $this->version == RSS1) $attrText = ' rdf:parseType="Resource"';
		...
		else $nodeText .= (in_array($tagName, $this->CDATAEncoding))? $tagContent : htmlentities($tagContent);
 ...
 /**
	...
	*/
	private function printChannels()
	{
		...
		foreach ($this->channels as $key => $value)
		{
			...
			else echo $this->makeNode($key, $value);
		}
	...
	*/
	...
	{
		if($this->version == RSS2) echo '<item>'.PHP_EOL;
		elseif($this->version == RSS1)
		{
			if($about) echo "<item rdf:about=\"$about\">".PHP_EOL;
			else die('link element is not set .\n It\'s required for RSS 1.0 to be used as about attribute of item');
		}
		elseif($this->version == ATOM) echo "<entry>".PHP_EOL;
	}
	/**
	...
	*/
	...
	{
		if($this->version == RSS2 || $this->version == RSS1) echo '</item>'.PHP_EOL;
		elseif($this->version == ATOM) echo "</entry>".PHP_EOL;
	}
}
class FeedItem
{
  ...
  /**
	...
	*/
	public function setLink($link)
	{
		if($this->version == RSS2 || $this->version == RSS1) $this->addElement('link', $link);
		else
		{
